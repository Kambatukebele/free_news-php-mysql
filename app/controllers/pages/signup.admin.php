<?php 
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST")
    {
        ...
        $stmt = "SELECT user_name FROM admin WHERE user_name = '$userName' LIMIT 1";
        ...
        $stmt_first_name = "SELECT first_name FROM admin WHERE first_name = '$firstName' LIMIT 1";
        ...
        $stmt_last_name = "SELECT last_name FROM admin WHERE last_name = '$lastName' LIMIT 1";
        ...
        $stmt_email = "SELECT email FROM admin WHERE email = '$email' LIMIT 1";
        ...
        {            
            ...
            $query = "INSERT INTO admin (user_name, first_name, last_name, email, password) VALUES (:user_name, :first_name, :last_name, :email, :password)";
